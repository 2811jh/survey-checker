...
- [ ] **Step 1: 在 `import_from_markdown` 末尾添加逻辑写入调用**
...
- [ ] **Step 1: 替换 import 和 SurveyChecker 方法**
...
- [ ] **Step 1: 删除 `logic_ops.py`**

```bash
git rm scripts/operations/logic_ops.py
```

- [ ] **Step 2: 清理 `question_ops.py` 中已注释的 logic_ops 引用**
...
- [ ] **Step 1: 更新 Step 3.7 — 移除"暂不支持逻辑"提示**
